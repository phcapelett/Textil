...
<lpt-grid-contrato 
    ...
    :contratos="{{json_encode($lista)}}"
    :empresas="{{json_encode($empresas)}}"
    :funcionarios="{{json_encode($funcionarios)}}"
    :tiposcontratos="{{json_encode($tiposcontratos)}}"
    :tiposcontratosexperiencia="{{json_encode($tiposcontratosexperiencia)}}"
    :funcao="{{json_encode($funcao)}}"
    ...
    :btnconfig="{{json_encode(\App\Utils\Functions::permissoesGlobal($obj->urlbase, '','C',$obj->urlbase))}}"
