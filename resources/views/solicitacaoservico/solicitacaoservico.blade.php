...
@section('content')
    ...
    <lpt-solicitacaoservico
    :lista="{{json_encode($solicitacaoservico)}}"
    :maquinasproducao="{{json_encode($maquinasproducao)}}"
    :solicitanteservico="{{json_encode($solicitanteservico)}}"
    :usuariologado="{{json_encode($usuariologado)}}"
    :obj="{{json_encode($obj)}}" 
