                ...
                <div class="misc-wrapper">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            <h2 class="mb-1">Você não tem acesso a URL informada 🕵🏻‍♀️</h2>
                            <p class="mb-2">Oops! 😖 Não se preocupe, Entre em contato com <strong>SETOR DE T.I.</strong>.</p>
                            <p class="mb-2">informando qual menu tentou acessar.</p>
                            <a class="btn btn-primary mb-2 btn-sm-block" href="/">Voltar Inicio</a>
